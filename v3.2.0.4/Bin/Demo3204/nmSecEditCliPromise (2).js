...
function SendMessagebyEvent(request) {
    var event = new CustomEvent(nmSecEditCtl.reqEventName, { detail: request });
    var documentObj=window.top.document
    documentObj.dispatchEvent(event);

    return new Promise(function (resolve, reject) {
        documentObj.addEventListener(nmSecEditCtl.respEventName, function CallBack(e) {
...
nmSecEditCtl.edgeExtension = "hopegfkajahagkaecnobonpfjnmjbkdn";
nmSecEditCtl.productID = "com.cfca.seceditctl.srcbcz";
...
nmSecEditCtl.prototype.init = function () {
    ...
    this.m_OutputValueType = object.attributes.OutputValueType.value;
    ...
    obj.OutputValueType = this.m_OutputValueType;
    paramArr.push(obj);
