...
if (typeof FO == "undefined") {
    ...
    FO.GET_KEY_STATE = "16";
    FO.GET_MAC_ADDRESS = "17";
    FO.GET_SM3_HASH_DATA = "18";
}
...
nmSecEditCtl.edgeExtension = "biphcfgechkjmfglclhgjaaomdgfidfp";
nmSecEditCtl.productID = "com.cfca.seceditctl.hxb";
...
nmSecEditCtl.prototype.GetOSVerInfo = function () {
    this.OSVerInfo = "";
    return SendToExt(nmSecEditCtl.browser, FO.GET_OS_VER_INFO, ObjectID);
}

nmSecEditCtl.prototype.GetNetInfo = function () {
    this.NetInfo = "";
    return SendToExt(nmSecEditCtl.browser, FO.GET_NETINFO, this.m_ObjectID);
}
...
nmSecEditCtl.prototype.SM3HashData = function (inData, inRand, inCert) {
    this.SM3Hash = "";
    return SendToExt(nmSecEditCtl.browser, FO.GET_SM3_HASH_DATA, this.m_ObjectID, inData, inRand, inCert);
}
    ...
    if (0 == response.errorcode) {
        ...
        switch (response.opcode) {
            ...
            case FO.GET_KEY_STATE:
                ...
                break;
            case FO.GET_SM3_HASH_DATA:
                object.SM3Hash = result;
                break;
        }
        return result;
    }
...
function SendToExt(browser, index, objID, para1, para2, para3) {
    var msgJSON = new Object();
    var paramArr = new Array();
    ...
    else if (index == FO.GET_SM3_HASH_DATA) {
        Op["InData"] = para1;
        if (para2)
            Op["Rand"] = para2;
        if (para3)
