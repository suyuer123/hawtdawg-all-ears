...
function LoadObj() {
    document.getElementById("FakeSecEditBox1").innerHTML = "<input type=\"password\" id=\"SecEditBox1\" size=\"30\" value=\"\" disabled=\"true\" MinLength=\"4\" MaxLength=\"24\" CipherType=\"1\" BorderWidth=\"0\" BorderColor=\"#CCEEFF|#FF0\" BackgroundColor=\"#0F0|#0D0\" ServerRandom=\"MDEyMzQ1Njc4OWFiY2RlZg==\" RestrictRegExp=\"([!-~]+)\" IntensityRegExp=\"(^[!-~]*[A-Za-z]+[!-~]*[0-9]+[!-~]*$)|(^[!-~]*[0-9]+[!-~]*[A-Za-z]+[!-~]*$)\"  OutputValueType=\"1\">";
    ...
    document.getElementById("FakeSecEditBox2").innerHTML = "<input type=\"password\" id=\"SecEditBox2\" size=\"30\" value=\"\" disabled=\"true\" MinLength=\"4\" MaxLength=\"24\" CipherType=\"1\" BorderWidth=\"0\" BorderColor=\"#CCEEFF|#FF0\" BackgroundColor=\"#0F0|#0D0\" ServerRandom=\"MDEyMzQ1Njc4OWFiY2RlZg==\" RestrictRegExp=\"([!-~]+)\" IntensityRegExp=\"(^[!-~]*[A-Za-z]+[!-~]*[0-9]+[!-~]*$)|(^[!-~]*[0-9]+[!-~]*[A-Za-z]+[!-~]*$)\" OutputValueType=\"1\">";
